/* Following is a sample program to demonstrate how fixed size records (that is, structures in C) can be written at arbitrary positions
in a file or can be read from arbitrary positions of a file. */
